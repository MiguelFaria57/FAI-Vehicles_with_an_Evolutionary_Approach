        ...
        public double Evaluate(IChromosome chromosome)
        {
            ...
            do
            {
                ...
                */
                ...
                if (MaxDistanceTime == 0)
                    fitness = 0;
                else
                {
                    fitness = MaxDistance + (MaxVelocity * 100) + IsRoadComplete * ((1 / MaxDistanceTime) * 1000);  // GapRoad Fitness Function
                    // fitness = MaxDistance + (MaxDistance / MaxDistanceTime) + IsRoadComplete * ((1 / MaxDistanceTime) * 1000);  // HillRoad Fitness Function
                }
